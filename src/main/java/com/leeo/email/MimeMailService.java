...
public class MimeMailService {
	...
	public void sendNotificationMail(String userName) {
		...
		try {
			...
			helper.setFrom("chenyuan.2008777@163.com");
			helper.setTo("825146938@qq.com");
			...
			logger.info("HTML版邮件已发送至chenyuan.2008777@163.com");
	...
	private String generateContent(String userName) throws MessagingException {
		...
		try {
			...
			return FreeMarkerTemplateUtils.processTemplateIntoString(this.template, context);
		} catch (IOException e) {
	 ...
	 * 获取classpath中的附件.
	 */
	private static File generateAttachment() throws MessagingException {
		try {
	...
	public void setFreemarkerConfiguration(Configuration freemarkerConfiguration) throws IOException {
		...
		this.template = freemarkerConfiguration.getTemplate("mailTemplate.ftl", DEFAULT_ENCODING);
	}
}
