...
public class JsonDateFormat extends AbstractObjectMorpher {
    ...
    public JsonDateFormat(String[] formats) {
        this(formats, Locale.getDefault(), false);
    }

    public JsonDateFormat(String[] formats, boolean lenient) {
        this(formats, Locale.getDefault(), lenient);
    }

    public JsonDateFormat(String[] formats, Date defaultValue) {
        this(formats, defaultValue, Locale.getDefault(), false);
    }

    public JsonDateFormat(String[] formats, Date defaultValue, Locale locale,
            boolean lenient) {
        super(true);
    ...
    public JsonDateFormat(String[] formats, Locale locale) {
        this(formats, locale, false);
    }

    public JsonDateFormat(String[] formats, Locale locale, boolean lenient) {
        if (formats == null || formats.length == 0) {
            throw new MorphException("invalid array of formats");
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof JsonDateFormat)) {
            return false;
        }

        JsonDateFormat other = (JsonDateFormat) obj;
    ...
    public boolean supports(Class clazz) {
        return String.class.isAssignableFrom(clazz)
            || Long.class.isAssignableFrom(clazz);//20151209增加long形式的日期转换
    }
}