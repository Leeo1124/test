...
//
//import com.framework.web.cgform.entity.config.CgFormFieldEntity;
//
...
//			com.framework.core.util.LogUtil.info("wordtohtml转换成功");
//		} catch (Exception e) {
//			e.printStackTrace();
//		} finally {
//			app.invoke("Quit", new Variant[] {});
...
//        }
//       
//        return sbFile==null?"":sbFile.toString();  
// }
//	/**
//	 * 字符串写入文件
//	 * 
...
//			
//			//添加<form>语句 
//			String ls_form = "<form action=\"cgFormBuildController.do?method=saveOrUpdate\" id=\"formobj\" name=\"formobj\" method=\"post\">\r\n" +
...
////		wordtohtml.wordToHtml("D://plat//qjd.doc", "D://plat//test.html");
//		wordtohtml.WordConverterHtml("D://plat//qjd.doc", "D://plat//test.html");
//		String htmlStr = wordtohtml.getInfo("D://plat//test.html");
//		htmlStr = wordtohtml.doPoiHtml(htmlStr);
//		wordtohtml.stringToFile(htmlStr,"D://plat//tt.html");
//	}catch (IOException e4) {}
//		
//	}
//	
